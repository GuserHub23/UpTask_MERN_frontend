...
const ModalEliminarColaborador = () => {
    ...
    return (
        <Transition.Root show={ modalEliminarColaborador  } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-1 overflow-y-auto" onClose={ handleModalEliminarColaborador }>
                            ...
                            <div className="sm:flex sm:items-start flex-col">
                                <div className='flex md:flex-row flex-col'>
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                        ...
                                        <div className='mt-2 bg-amber-200 p-4 border-l-4 border-orange-600 flex items-center gap-3'>
                                            <svg 
                                            ...
                                            <p className='text-sm text-gray-800'>
                                                {`¿Deseas eliminar a ${colaborador.nombre || 'usuario'} del proyecto?. Prodra reintegrarse si lo agregas de nuevo.`}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-5 sm:mt-4 mx-auto sm:flex sm:flex-row-reverse">
                                    <button
                                        type="button"
